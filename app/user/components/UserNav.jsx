    ...
    <nav className="bg-[#FFFFFF] dark:bg-gray-900 fixed z-20 top-0 left-0 right-0 mx-auto rounded-br-[20px] rounded-bl-[20px] shadow-md w-[70%] border-b border-gray-200 dark:border-gray-600 font-sans">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a
          ...
          className="flex items-center space-x-3 rtl:space-x-reverse"s
        >
          <img src="/logo4.png" className="h-18" alt="Flowbite Logo" />
        </a>
        <div className="flex md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">

        <button type="button" class="text-gray-900 bg-[#A1E67D] rounded-br-[25px] shadow-md  rounded-tr-[10px]  rounded-tl-[10px]
       ...
       <img src="/rank.png" alt="Lime" class="w-full h-12 object-cover" />
        ...
        <a href="YOUR_BUTTON_URL_HERE">
          <img src="/Profile.png" className="h-18 mb-[4px]" alt="Get Started" />
        </a>
          <button
            onClick={toggleMenu}
            type="button"
