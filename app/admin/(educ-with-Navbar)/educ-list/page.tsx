    ...
    <div className="bg-teal-100">
      ...
      <div className="student">
        <h1 className="studenthead">
          Student List
          <Link href="/admin/educ-list/educ-addStudent">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {users.map((user, index) => (
                <tr key={index} className="bod">
                  ...
                  <td className="buttonview">
                    <Link href={`/admin/educ-list/pre-test-results?user_id=${user.user_id}`}>
                      <button>View</button>
                    </Link>
                  </td>
                  ...
                  <td className="editbutton px-6 py-4 whitespace-nowrap">
                    <Link href={`/admin/educ-list/educ-editStudent?user_id=${user.user_id}`}>
